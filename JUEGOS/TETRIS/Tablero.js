...
class Tablero {
  ...
  /* la variable que se encargará de representar los minos almacenados en el tablero*/
  ...
  /*  Se encargará del procesamiento lógico para el dibujado  de este elemento */
  dibujar() {
    push();
    noStroke();
    for (let columna = 0; columna < this.columnas; columna++) {
